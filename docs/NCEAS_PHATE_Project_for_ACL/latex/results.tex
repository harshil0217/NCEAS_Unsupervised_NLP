...
We additionally evaluate robustness to noise by introducing perturbations to the synthetic datasets. Under noisy conditions, global structure preservation further degrades, with Spearman and DEMaP values remaining close to zero, indicating that dimensionality reduction methods struggle to maintain meaningful distance relationships in the presence of noise.

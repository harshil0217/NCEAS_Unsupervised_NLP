...
In addition to ARI, we also report Adjusted Mutual Information (AMI), which measures agreement between predicted and ground-truth cluster assignments while accounting for chance.

We analyze global structure preservation using Shepard diagrams, which compare pairwise distances in high- and low-dimensional spaces.

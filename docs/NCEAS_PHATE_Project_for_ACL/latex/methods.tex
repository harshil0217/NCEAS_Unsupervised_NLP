...
\begin{description}
    ...
    \item[TriMAP] emphasizes preservation of global structure by optimizing triplet relationships between points, ensuring that relative distances are maintained in the low-dimensional embedding.
\end{description}
